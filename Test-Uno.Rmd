...
```{r}
#-- This is gives an error with N=600 -- no unlabeled training data
#-- "ht" becomes too small number <-100000
...
```{r}
#-- This is equivalent to TrainN and ValidN are NULL (This works with N=600 -- no unlabeled training data)
